...
*/
	...
	public static void main(String[] args) {
		...
		client.addServer(new ServerProperties("192.168.102.3", 8888));
		client.addServer(new ServerProperties("192.168.102.4", 8888));
		client.addServer(new ServerProperties("192.168.102.5", 8888));
		client.connect(args);
	}
}
